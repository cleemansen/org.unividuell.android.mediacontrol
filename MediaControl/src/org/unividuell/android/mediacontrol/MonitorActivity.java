...
public class MonitorActivity extends Activity {
	...
	protected void onResume() {
		super.onResume();
		// audio manager handles duplicates; so don't worry about adding it
		// twice.
		mAudioManager.registerMediaButtonEventReceiver(mRemoteControlReceiver);
	}
	...
	protected void onDestroy() {
		...
		mAudioManager
				.unregisterMediaButtonEventReceiver(mRemoteControlReceiver);
		instance = null;
	}
	 ...
	 * @see http://stackoverflow.com/a/18909835
	 * 
	 * @param cmd
	 *            command to send to the OS music player.
	 */
